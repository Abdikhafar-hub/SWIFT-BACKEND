...
import { clientPaymentProofRoutes, adminPaymentProofRoutes } from "./modules/financial/payment-proof.routes.js";
...
v1Router.use("/admin/payment-proofs", adminPaymentProofRoutes);
v1Router.use("/admin/payment-verifications", adminPaymentProofRoutes);
